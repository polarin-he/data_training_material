# POLARIN Data Curation Training Material
## Repository Content
This folder provides guidance on combining, formatting, transforming, preparing data to adhere to the FAIR data standards. It emphasizes the importance of maintaining data accessibility and usability over time.

### Key Topics
- **Internationally accepted (meta-)data standards and file structures**
- **Structuring datasets for interoperability and reusability**
