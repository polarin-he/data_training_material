...
#### Prerequisites
- No prior knowledge of data management is required. 
- (Optional but recommended) Basic familiarity with research data, metadata (information describing data) and data repositories.
