...
**Purpose**: The POLARIN Data Hub brings together polar research data from across a wide network of Arctic and Antarctic Research Infrastructures. But knowing that the data exists is only the first step — users also need to know *how* to find what they need, *how* to explore it, and *how* to get it into their analysis workflow. 
...
- (Recommended) Completion of *Notebook 1: How to use the POLARIN Data Hub?* and *Notebook 2: Helpful data tools developed by POLARIN*.
