...
>NOTE: *This notebook gives some references to literature that might help in understanding the data concepts introduced in this learning module. All these existing, external training materials are also compiled in the [POLARIN Training Resources Database](https://docs.google.com/spreadsheets/d/1jOIR7_TRfE7lSWVhZXE4R-0jSLxTL4sT7mWvTqiO3nY/edit?usp=sharing) and tagged according to the chapter they are used in. Just like this training material repository, this is supposed to be a living document.
